...
# Custom CSS for styling titles and text
st.markdown("""
    <style>
    /* Títulos centrados y más pequeños */
    .css-1v3fvcr {
        text-align: center;
        font-size: 24px;  /* Título principal reducido */
    }
    .css-19k0g9p {
        text-align: center;
    ...
    .css-1jyx5a4 {
        font-size: 16px;  /* Tamaño de los sub-títulos */
    }
    </style>
